...
export default function VideoPortfolio() {
  ...
  const activeVideo = portfolioVideos.find((video) => video.id === activeId) ?? portfolioVideos[0];
    ...
    <main className="portfolio-page">
      ...
      <section className="portfolio-hero">
        ...
        <div className="portfolio-width portfolio-hero-content">
          <motion.p initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }} className="portfolio-kicker"><span /> Auto Truck Motion Archive</motion.p>
      ...
      <section className="portfolio-grid-section">
        <div className="portfolio-width">
          <div className="portfolio-section-heading"><div><span className="portfolio-detail-label">Arquivo audiovisual</span><h2>Escolha uma<br /><em>cena.</em></h2></div><p>Todos os vídeos foram preparados para carregamento fluido e reprodução em alta definição.</p></div>
      ...
      <section className="portfolio-contact">
        <div className="portfolio-width portfolio-contact-inner">
          ...
          <a href={WHATSAPP_URL} target="_blank" rel="noreferrer">Solicitar atendimento <ArrowUpRight size={19} /></a>
        </div>
      </section>
    </main>
  );
